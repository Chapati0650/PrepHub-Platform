  ...
  if (!schoolId) {
    return (
      <div className="mx-auto flex max-w-lg flex-col items-center gap-4 p-8 text-center">
        <h1 className="text-xl font-semibold">Announcements aren&apos;t available for this account.</h1>
    ...
    <div className="mx-auto flex max-w-2xl flex-col gap-8 p-4 sm:p-8">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Share a brief update with your registered students. Announcements appear inside PrepHub and are emailed once, at
          publish time.
        </p>
      </div>
