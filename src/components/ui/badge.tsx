...
// rounded-md, not a full pill (was rounded-4xl) — a tight tag shape reads as
// a genuine status marker (Linear/GitHub label), not decoration; every badge
// in the app used the exact same loud stadium shape regardless of what it
// was marking, which flattened "important state" and "routine label" into
// looking identical.
