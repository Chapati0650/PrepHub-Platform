...
// PRD-012 §21 / PRD-006: "If a native embedded Desmos experience is not
// technically available during initial development, PrepHub may use an
// equivalent approved calculator solution while preserving the intended
// workflow." A real Desmos embed needs a registered API key this environment
// doesn't have; this is that approved fallback — a self-contained four-function
// calculator that lives directly in the question interface, same as Desmos would.
const BUTTONS = [
  "7", "8", "9", "/",
  "4", "5", "6", "*",
  "1", "2", "3", "-",
